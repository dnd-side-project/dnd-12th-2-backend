INSERT IGNORE INTO users (user_id, nickname, profile_image_url, device_token, email) 
...
INSERT IGNORE INTO user_guides (user_id, type, content) 
...
INSERT IGNORE INTO goals (goal_id, user_id, title, is_achieved, created_at, updated_at) 
VALUES (1, 1, 'user1_goal1', TRUE, DATETIME('now', '-1 month'), DATETIME('now', '-1 month'));
INSERT IGNORE INTO goals (goal_id, user_id, title, is_achieved, created_at, updated_at, deleted_at) 
...
INSERT IGNORE INTO goals (goal_id, user_id, title) 
...
INSERT IGNORE INTO plan_histories (plan_id, history_id, goal_id, guide) 
VALUES (1, 1, '{"goal1_history1_guide1"}');
INSERT IGNORE INTO plan_histories (history_id, goal_id, guide) 
...
INSERT IGNORE INTO plans (plan_id, history_id, goal_id, title, is_succeed, guide, start_date, end_date) 
...
INSERT IGNORE INTO plan_feedbacks (plan_id, question, indicator) 
