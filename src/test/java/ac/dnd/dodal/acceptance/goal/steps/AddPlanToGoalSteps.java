...
public class AddPlanToGoalSteps {
    ...
    private static final String BASE_URL_WITH_HISTORY = "/api/goals/{goalId}/plans/{planId}";
    ...
    public static Response addPlanWhenSuccess(Long goalId, Long planId,
    ...
    public static Response addPlanWhenFailure(Long goalId, Long planId,
